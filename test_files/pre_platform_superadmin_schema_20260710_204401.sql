...
--
-- Name: framework_versions framework_versions_source_package_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.framework_versions
    ADD CONSTRAINT framework_versions_source_package_id_fkey FOREIGN KEY (source_package_id) REFERENCES public.content_source_packages(id);
