...
--
-- Name: control_mappings control_mappings_app_context_isolation; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY control_mappings_app_context_isolation ON public.control_mappings USING ((tenant_id = public.app_current_tenant())) WITH CHECK ((tenant_id = public.app_current_tenant()));


--
-- Name: control_mappings control_mappings_tenant_isolation; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY control_mappings_tenant_isolation ON public.control_mappings USING (((tenant_id)::text = COALESCE((auth.jwt() ->> 'tenant_id'::text), ''::text))) WITH CHECK (((tenant_id)::text = COALESCE((auth.jwt() ->> 'tenant_id'::text), ''::text)));
...
--
-- Name: control_sets control_sets_app_context_isolation; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY control_sets_app_context_isolation ON public.control_sets USING ((tenant_id = public.app_current_tenant())) WITH CHECK ((tenant_id = public.app_current_tenant()));


--
-- Name: control_sets control_sets_tenant_isolation; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY control_sets_tenant_isolation ON public.control_sets USING (((tenant_id)::text = COALESCE((auth.jwt() ->> 'tenant_id'::text), ''::text))) WITH CHECK (((tenant_id)::text = COALESCE((auth.jwt() ->> 'tenant_id'::text), ''::text)));
...
--
-- Name: control_subcontrols control_subcontrols_app_context_isolation; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY control_subcontrols_app_context_isolation ON public.control_subcontrols USING ((tenant_id = public.app_current_tenant())) WITH CHECK ((tenant_id = public.app_current_tenant()));


--
-- Name: control_subcontrols control_subcontrols_tenant_isolation; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY control_subcontrols_tenant_isolation ON public.control_subcontrols USING (((tenant_id)::text = COALESCE((auth.jwt() ->> 'tenant_id'::text), ''::text))) WITH CHECK (((tenant_id)::text = COALESCE((auth.jwt() ->> 'tenant_id'::text), ''::text)));
...
--
-- Name: controls controls_app_context_isolation; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY controls_app_context_isolation ON public.controls USING ((tenant_id = public.app_current_tenant())) WITH CHECK ((tenant_id = public.app_current_tenant()));


--
-- Name: controls controls_tenant_isolation; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY controls_tenant_isolation ON public.controls USING (((tenant_id)::text = COALESCE((auth.jwt() ->> 'tenant_id'::text), ''::text))) WITH CHECK (((tenant_id)::text = COALESCE((auth.jwt() ->> 'tenant_id'::text), ''::text)));
...
--
-- Name: framework_versions framework_versions_app_context_isolation; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY framework_versions_app_context_isolation ON public.framework_versions USING ((tenant_id = public.app_current_tenant())) WITH CHECK ((tenant_id = public.app_current_tenant()));


--
-- Name: framework_versions framework_versions_tenant_isolation; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY framework_versions_tenant_isolation ON public.framework_versions USING (((tenant_id)::text = COALESCE((auth.jwt() ->> 'tenant_id'::text), ''::text))) WITH CHECK (((tenant_id)::text = COALESCE((auth.jwt() ->> 'tenant_id'::text), ''::text)));
...
--
-- Name: frameworks frameworks_app_context_isolation; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY frameworks_app_context_isolation ON public.frameworks USING ((tenant_id = public.app_current_tenant())) WITH CHECK ((tenant_id = public.app_current_tenant()));


--
-- Name: frameworks frameworks_tenant_isolation; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY frameworks_tenant_isolation ON public.frameworks USING (((tenant_id)::text = COALESCE((auth.jwt() ->> 'tenant_id'::text), ''::text))) WITH CHECK (((tenant_id)::text = COALESCE((auth.jwt() ->> 'tenant_id'::text), ''::text)));
...
--
-- Name: mapping_reviews mapping_reviews_app_context_isolation; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY mapping_reviews_app_context_isolation ON public.mapping_reviews USING ((tenant_id = public.app_current_tenant())) WITH CHECK ((tenant_id = public.app_current_tenant()));


--
-- Name: mapping_reviews mapping_reviews_tenant_isolation; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY mapping_reviews_tenant_isolation ON public.mapping_reviews USING (((tenant_id)::text = COALESCE((auth.jwt() ->> 'tenant_id'::text), ''::text))) WITH CHECK (((tenant_id)::text = COALESCE((auth.jwt() ->> 'tenant_id'::text), ''::text)));
...
--
-- Name: mapping_versions mapping_versions_app_context_isolation; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY mapping_versions_app_context_isolation ON public.mapping_versions USING ((tenant_id = public.app_current_tenant())) WITH CHECK ((tenant_id = public.app_current_tenant()));


--
-- Name: mapping_versions mapping_versions_tenant_isolation; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY mapping_versions_tenant_isolation ON public.mapping_versions USING (((tenant_id)::text = COALESCE((auth.jwt() ->> 'tenant_id'::text), ''::text))) WITH CHECK (((tenant_id)::text = COALESCE((auth.jwt() ->> 'tenant_id'::text), ''::text)));
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE public.control_mappings TO app_runtime;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE public.framework_content_packs TO app_runtime;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE public.framework_requirements TO app_runtime;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE public.remediation_tasks TO app_runtime;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE public.rights_request_tasks TO app_runtime;
